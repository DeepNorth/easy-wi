...
if (is_file(EASYWIDIR . '/vendor/monstaftp/languages/' . $user_language . '.php')) {
    include(EASYWIDIR . '/vendor/monstaftp/languages/' . $user_language . '.php');
} else {
    include(EASYWIDIR . '/vendor/monstaftp/languages/' . $default_language . '.php');
}
